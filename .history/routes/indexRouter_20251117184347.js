...
const {forgotPass, resetPassword} = require('../controllers/authController');
...
console.log("POST /reset-password/:tokenid route LOADED");
router.post('/reset-password/:tokenid', validate(newPass), resetPassword);
router.post('/reset-password/:tokenid',validate(newPass), resetPassword);
