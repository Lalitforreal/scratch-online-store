...
router.get("/owners/allproducts",async function(req,res){
    const success = req.flash('success');
    let products = await productModel.find();
    res.render("editproduct", {products, success});
})

router.get('/remove/:productid',async function(req,res){
    let removedProduct = await productModel.findOneAndDelete({id : req.params.productid });
